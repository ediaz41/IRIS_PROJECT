...
team_names = st.sidebar.text_area(
    "Nombres del equipo", 
    value="ERNESTO DIAZ, NICOLLE ALGARIN", 
    help="Escribe los nombres de los miembros del equipo tal como deben aparecer en el repo y la presentación."
)
